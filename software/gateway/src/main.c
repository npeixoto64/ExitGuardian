...
int main(void)
{
  ...
  GPIO_Init(GPIOB, GPIO_Pin_5, GPIO_Mode_Out_PP_Low_Fast);  // SCK
  GPIO_Init(GPIOB, GPIO_Pin_6, GPIO_Mode_In_FL_No_IT);      // MISO
  GPIO_Init(GPIOB, GPIO_Pin_7, GPIO_Mode_Out_PP_Low_Fast);  // MOSI
